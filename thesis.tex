...
TODO: Researching pitch estimation is not accessible, as multiple AMT subproblems (e.g. onset detection) have to be solved in order to produce a working prototype on which experiments can be performed. This hinders research of one specific subproblem. Furthermore, as every pitch estimation system is set up slightly different, the combinations of different solutions for the subproblems cannot easily be experimented on. Lastly, experimentation is difficult...
...
% \textcolor{gray}{TODO: Audio is represented by samples. We get these samples from the OS audio driver. Driver latency.}
...
Different components of Digistring.
