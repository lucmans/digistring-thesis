...
% We will start with constructing a very basic pitch estimation algorithm which we will refine...
...
% \subsection{Bin interpolation}
\subsection{Zero padding}
% \textcolor{gray}{TODO: Split this in two subsections?}
