...
\textcolor{gray}{JSON output and \texttt{generate\_report} tool.}

\textcolor{gray}{Performance (speed) measuring.}

\textcolor{gray}{Estimator graphics.} Estimator can optionally define an Estimator graphics object, which holds information regarding the last pitch estimated frame. This information can be rendered using visualizers. Currently, we implemented four visualizers (add screenshots).
