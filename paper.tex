...
\textcolor{gray}{TODO: Mention other methods of solving this problem.}
...
\subsection{Transients and envelope}
\textcolor{gray}{When you pluck a string, first signal behaves very chaotically. ADSR envelope.}
